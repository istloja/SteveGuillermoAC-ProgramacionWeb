...
public class PrestamoController implements Serializable {
    ...
    @EJB
    private Mysql.PrestamoFacade ejbFacade;
    ...
    public Prestamo getSelected() {
        if (current == null) {
            ...
            current.setPrestamoPK(new Beans.PrestamoPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Prestamo getPrestamo(Beans.PrestamoPK id) {
    ...
    public static class PrestamoControllerConverter implements Converter {
        ...
        Beans.PrestamoPK getKey(String value) {
            Beans.PrestamoPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new Beans.PrestamoPK();
            key.setIdprestamo(Integer.parseInt(values[0]));
            key.setLibroIdlibro(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(Beans.PrestamoPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getIdprestamo());
            sb.append(SEPARATOR);
            sb.append(value.getLibroIdlibro());
            return sb.toString();
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Prestamo) {
                ...
                return getStringKey(o.getPrestamoPK());
            } else {
